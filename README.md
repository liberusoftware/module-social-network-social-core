# Social Network: Social Core Core Module

> This package is the authoritative, provider-neutral implementation of Social Core. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-social-core?sort=semver)](https://github.com/liberusoftware/module-social-network-social-core/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-social-core/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-social-core/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-social-core
```
...
<a href="https://github.com/liberusoftware/module-social-network-social-core/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-social-core" alt="Contributors to liberusoftware/module-social-network-social-core">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-social-core/graphs/contributors).
